...
public class Movimentacao implements Serializable {
	...
	// -------------------------------
	public interface AlterarMovimentacao {
	}

	public interface InserirMovimentacao {
	}
	...
	@NotNull(message = "O código da MOVIMENTAÇÃO não deve ser nulo", groups = { AlterarMovimentacao.class })
	...
	@NotNull(message = "A data de solicitação da MOVIMENTAÇÃO não deve ser nula", groups = {
			AlterarMovimentacao.class, InserirMovimentacao.class })
	...
	@NotNull(message = "A cid principal da MOVIMENTAÇÃO não deve ser nula", groups = { InserirMovimentacao.class })
	...
	@NotNull(message = "O médico da MOVIMENTAÇÃO não deve ser nulo", groups = { InserirMovimentacao.class })
	private Medico medico;

	@NotNull(message = "O paciente da MOVIMENTAÇÃO não deve ser nulo", groups = { InserirMovimentacao.class })
	private Paciente paciente;

	private List<MovimentacaoProcedimento> procedimentos;

	@NotNull(message = "O programa da MOVIMENTAÇÃO não deve ser nulo", groups = { InserirMovimentacao.class })
	...
	// public List<MovimentacaoCID> getCids() {
	// return cids;
	// }
	//
	// public void setCids(List<MovimentacaoCID> cids) {
	// this.cids = cids;
	// }
