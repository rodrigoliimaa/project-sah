...
/**
 * Servlet implementation class PreviewComprovanteEncaminhamento
 */
public class PreviewComprovanteEncaminhamento extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PreviewComprovanteEncaminhamento() {
        super();
    ...
    protected void doGet(HttpServletRequest request,
		...
		try {
			...
			String file = "previewComprovanteEncaminhamentoOrteseProtese.jasper";
