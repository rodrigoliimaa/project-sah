...
/**
 * Servlet implementation class PreviewEncaminhamentoExterno
 */
public class PreviewEncaminhamentoExterno extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public PreviewEncaminhamentoExterno() {
		super();
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			preAtendimento.setSequencial(seqPaciente);
			
			List<PreAtendimento> lista =facade.listarEncaminhamentoExterno(preAtendimento);			
			
			// **********************************************************************************************
			
			String file = "previewEncaminhamentoExterno.jasper";
			...
			System.out.println("Erro inesperado relatorio encaminhamento Externo: "
					+ e.getMessage());
			e.printStackTrace();
		}
